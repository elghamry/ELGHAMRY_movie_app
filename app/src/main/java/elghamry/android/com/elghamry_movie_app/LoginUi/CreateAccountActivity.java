...
import elghamry.android.com.elghamry_movie_app.Model.User;
...
public class CreateAccountActivity extends AppCompatActivity {
    ...
    public void onCreateAccountPressed(View view) {
        ...
        mFirebaseRef.createUser(mUserEmail, mPassword, new Firebase.ValueResultHandler<Map<String, Object>>() {
            ...
            public void onSuccess(Map<String, Object> result) {
                ...
                mAuthProgressDialog.setMessage("Acount Created");
    ...
    private void createUserInFirebaseHelper() {
        ...
        Intent intent = new Intent(CreateAccountActivity.this,Login.class);
        intent.putExtra("email",mUserEmail).putExtra("src","CreateActivity");
        startActivity(intent);
        finish();
